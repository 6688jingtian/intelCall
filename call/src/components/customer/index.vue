<template>
	<div class="chatContain">
		...
		<div class="footBar" @click="open()">
		  <span>任务id:{{lala}}</span>
		  <span style="position: absolute;right: 0;cursor: pointer;">展开通话</span>
		  <img src="" />
		</div>
	</div>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      titleImageUrl: 'data:image/png;base64,',
      newMessagesCount: 0,
  ...
  methods: {
		open: function(){
			this.$bus.$emit('chatMes',this.cover);
			this.$bus.$emit('chatMe',this.haha);
			//this.$bus.$emit('chatMe',this.haha);
